...
<html lang="en">
    ...
    <%String username=(String)session.getAttribute("username"); %>
		...
		.custom-table th {
		    background-color: #8da89e; /* Header background color */
		    color: #d9dedc; /* Header text color */
		}
		
		.custom-table tbody tr:nth-child(even) {
		    background-color: #cee0da; /* Alternate row background color */
		}
		
		.custom-table tbody tr:hover {
		    background-color: #7c948b; /* Hovered row background color */
    ...
    <body class="body">
        ...
        <nav class="vertical-nav">
            <ul>
                ...
                <li class="current"><a href='seeevents.jsp?email=${list1.getSemial()}'>See Events</a></li>
    ...
    <tbody>
	     <% List<eventbean> lis = new ArrayList<eventbean>(); 
	     lis = eventdao.showevent();
	     request.setAttribute("list1", lis);%>
	     <%    int a=1; %>
