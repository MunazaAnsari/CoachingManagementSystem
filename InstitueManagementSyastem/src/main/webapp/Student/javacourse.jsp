...
.details p {
    ...
    <hr>
    <p class="overview">
        Build modern web applications with Java, Spring, and cutting-edge frontend technologies.
    </p>
    <div class="details">
        <h3>Course Highlights</h3>
        <ul>
            <li>Java, Spring, and SQL essentials</li>
            <li>Frontend with HTML, CSS, and JS</li>
            <li>RESTful APIs and React/Angular</li>
            <li>Flexible schedule & hands-on labs</li>
        </ul>
