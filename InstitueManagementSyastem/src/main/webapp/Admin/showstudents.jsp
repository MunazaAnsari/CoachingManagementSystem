     ...
     <%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %>
        ...
        <style>
            ...
            .container {
                ...
                margin: 50px 210px; /* Center the container horizontally */
		...
		.custom-table tbody tr:hover {
		    background-color: #dbdad5; /* Hovered row background color */
...
.button-link:hover {
    background-color: #cdcac2; /* Button background color on hover */
    ...
    <tbody>
	     ...
	     <c:forEach items="${list1}" var="u">  
	       <tr>
	         ...
	         <td>${u.getSemial()}</td>
	         <td>${u.getScontact()}</td>
	         <td class = "width" >${u.getSdob()}</td>
	         <td>${u.getSaddress()}</td>
	         <td>${u.getSpin()}</td>
	         <td>${u.getScourse()}</td>
	         <td>${u.getSfpaid()}</td>
	         <td>${u.getSfpending()}</td>
	         <td>${u.getSftotal()}</td>
	         
	         
	         <td   ><a  type="button" class="button-link"href='editstudent.jsp?sid=${u.getSid()}'>Edit</a>
	         <a  type="button"  class="button-link" href='../deletereigstered?sid=${u.getSid()}'>Delete</a></td>
	       </tr>
	      </c:forEach>
