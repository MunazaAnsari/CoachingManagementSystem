     ...
     <%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %>
        ...
        <style>
            ...
            .container {
                ...
                margin: 50px 250px; /* Center the container horizontally */
		...
		.custom-table tbody tr:nth-child(even) {
		    background-color: #f7f4ed; /* Alternate row background color */
		}
    ...
    <tbody>
	     ...
	     <c:forEach items="${list1}" var="u">  
	       <tr>
	         ...
	         <td  colspan="2" ><a  type="button" class="button-link"href='../approvestudent?sid=${u.getSid()}'>Approve</a>
	         <a  type="button"  class="button-link" href='../deletestudent?sid=${u.getSid()}'>Delete</a></td>
	       </tr>
	      </c:forEach>
