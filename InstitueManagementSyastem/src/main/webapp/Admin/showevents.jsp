    ...
    <tbody>
	     ...
	     <c:forEach items="${list1}" var="u">  
	       <tr>
	         ...
	         <td   ><a  type="button" class="button-link"href='editevents.jsp?id=${u.getId()}'>Edit</a>
	         <a  type="button"  class="button-link" href='../deleteevent?id=${u.getId()}'>Delete</a></td>
	       </tr>
	      </c:forEach>
            </tbody>
</table>
