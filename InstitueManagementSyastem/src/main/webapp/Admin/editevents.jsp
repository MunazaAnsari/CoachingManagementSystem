...
<html lang="en">
    ...
    <body class="body">
        <div class="navbar">
            <div class="navtext"><h1>InstituteName</h1></div>
        </div>
        ...
        <h1>Events</h1>
        <% eventbean list = new eventbean(); 
        int id=Integer.parseInt(request.getParameter("id"));
	     list = eventdao.getevent(id);
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="registration-form">
                        <h2>Add Events</h2>
                        <form action="../editevents" method="POST">
                        <input type="hidden" id="id" name="id" value = '${list1.getId()}' placeholder="Enter event name" required />
                            <div class="input-group">
                                <label for="name">Name</label>
                                <input type="text" id="name" name="name" value = '${list1.getEname()}' placeholder="Enter event name" required />
                            </div>
                            <div class="input-group">
                                <label for="email">Description</label>
                                <textarea id="w3review" name="description" rows="4" cols="50"> ${list1.getEdeescription()}</textarea>
                            </div>
                            <div class="input-group">
                                <label for="email">Date</label>
                                <input type="date" id="contact" name="date" value = '${list1.getEdate()}' placeholder="Enter event date" required />
                            </div>
